...
export interface IRenderer {
  ...
  // Drop the backdrop for the duration of a capture, so formats that carry an
  // alpha channel (PNG, WebM) can export the device on transparency. Renderers
  // that have no separable background simply do not implement it.
