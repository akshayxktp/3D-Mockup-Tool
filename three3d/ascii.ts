...
export interface AsciiOptions {
  ...
  // Click-to-focus result, in top-down viewport UV. Mockup blur only.
  ...
  onRenderer?: (handle: {
    ...
    // Mockup only: drop the backdrop for a capture so PNG/WebM can export the
    // device on transparency.
